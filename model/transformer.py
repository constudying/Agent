...
import IPython  # 导入 IPython 交互式开发环境
e = IPython.embed  # 创建一个嵌入式 IPython shell 的快捷方式
...
class Transformer(nn.Module):
    ...
    def forward(self, src, mask, query_embed, pos_embed, proprio=None, additional_pos_embed=None):
        if len(src.shape) == 4:
            bs, c, h, w = src.shape
